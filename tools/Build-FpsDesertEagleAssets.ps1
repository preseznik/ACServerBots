...
foreach ($required in @($BlenderPath, $sourceScript, $validationScript, $sourceFbx,
...
& $BlenderPath --background --python $sourceScript -- `
    --source-dir $SourceDirectory --output-dir $OutputDirectory --exporter-root $exporterRoot `
    --success-marker $buildMarker
