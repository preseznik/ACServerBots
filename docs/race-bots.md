...
- uses `fast_lane.ai` radius and side-width fields for corner speed, following, proactive committed passes around AI or human cars, AI obstacle avoidance, and collision recovery; low aggression increases the following gap and commitment time but no longer disables passing;
